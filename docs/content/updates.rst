...
v0.11.0
=================================
| - `#132 <>`_`: Fixes issue with p-value/FDR calculation in interactive datatable formatting module
| - `#134 <>`_`, `#136 <>`_`: Moves curated files to Sourceforge, adds automated scripts for release building
| - `#128 <>`_`, `#129 <>`_`, `#130 <>`_`, `#131 <>`_`: Returns more information for values not being mapped to networks
