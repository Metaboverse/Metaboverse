class MetaGraph{
    constructor(graphdata){
        ...
        this.pathways = graphdata.pathways;
        // this.graphdata = this.process_data(graphdata);
        ...
        this.stamp_svg_margin = {"top":5, "left":5, "horizontal":10, "vertical":10};
    ...
    drawMotifSearchResult(motif_list){
        ...
        let stamp_height = 50;
        this.stamp_svg_height = Math.ceil(motif_list.length/3)*(stamp_height+this.stamp_svg_margin.vertical);
        this.stamp_svg.attr("height",this.stamp_svg_height);

        let stamp_width = this.stamp_svg_width/3-this.stamp_svg_margin.horizontal;
    ...
    drawMotifPathway(motif){
        ...
        this.mp_svg_height = Math.ceil(pathway_list.length/3)*(pathway_height+margin.vertical)
+motif_height+margin.top;
