...
"""
from .__init__ import __version__, __dependencies__
from .utils import check_directories, check_curate, check_analyze
...
def get_dependencies(
    ...
    for d in dependencies:
        os.system('pip freeze | grep -i \"' + str(d) + '\" >> ' + str(args_dict['log_loc']) + 'dependencies.log')
...
def check_arguments(
    ...
    os.system(
        ...
        + str(args_dict['log']))
    print(
        'MetaboNet-Analyzer version: ' + str(__version__))
