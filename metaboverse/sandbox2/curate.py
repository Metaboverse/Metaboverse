...
def __main__(
    ...
    print('Step 0/5: Reading in source data...')
    source = read_source(
    ...
    print('Step 1/5: Curating compartments...')
    ...
    print('Step 2/5: Curating processes...')
    ...
    print('Step 3/5: Curating metabolites...')
    ...
    print('Step 4/5: Curating reactions...')
